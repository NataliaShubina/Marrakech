...
uniform sampler2D u_textures2d[3];
...
{
	float depth = texture2D(u_textures2d[2], uv).x;
...
void main()
{
	...
	vec4 color1 = texture2D(u_textures2d[1], v_uv);
	vec4 color2 = texture2D(u_textures2d[1], uv2);
	vec4 color3 = texture2D(u_textures2d[1], uv3);
	vec4 color4 = texture2D(u_textures2d[1], uv4);
	vec4 color5 = texture2D(u_textures2d[1], uv5);
	vec4 color6 = texture2D(u_textures2d[1], uv6);
	vec4 color7 = texture2D(u_textures2d[1], uv7);
	vec4 color8 = texture2D(u_textures2d[1], uv8);
	vec4 color9 = texture2D(u_textures2d[1], uv9);
	...
	vec4 colorOriginal = texture2D(u_textures2d[0], v_uv);
